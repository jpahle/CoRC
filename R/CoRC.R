...
#' @export
COPASI_VERSION <- "https://github.com/copasi/COPASI/commit/3bd6271380f60a22b6054fb0eab4c149b04d9599"
...
COPASI_BIN_HASHES <-
  list(
    ...
    "3.4" =
      c(
        darwin = "a68d76e4d2c5fc3b8de420f1fa46a3f53bf5dd6a399da67d6b3097c326d651c8"
        # win = "",
        # ubuntu_16_10 = ""
      )
  )
