...
timeCourseTask$setMethodType("deterministic")
...
optTask$setMethodType("LevenbergMarquardt")
...
optProblem$setSubtaskType("timeCourse")
...
optItem <- optProblem$addOptItem(CDataObject_getCN((fixedModelValue$getObject(CCommonName("Reference=InitialValue")))))
...
report$setTaskType("optimization")
...
header$push_back(CRegisteredCommonName(s))
...
s <- o$getCN()$getString()
body$push_back(CRegisteredCommonName(s))
...
rep$setReportDefinition(report)
# set the output filename
rep$setTarget("example5.txt")
