...
rm -rf bin/ tmp/ bin_darwin_x64/
./createOSX-qt5.sh
mv bin/ bin_darwin_x64/
cd ../../../
```
...
cd ../
cp corc_darwin_x64/copasi/bindings/R/COPASI.so libs/COPASI_darwin_x64.so
...
cmake \
  ...
  -DR_INCLUDE_DIRS="C:/Program Files/R/R-3.4.1/include" \
  -DR_INTERPRETER="C:/Program Files/R/R-3.4.1/bin/R.exe" \
