...
Make sure to fix the paths for R in this script.
...
cmake -G Ninja ^
  ...
  -DR_INCLUDE_DIRS="%ProgramFiles%/R/R-3.4.2/include/" ^
  -DR_INTERPRETER="%ProgramFiles%/R/R-3.4.2/bin/R.exe" ^
...
Clears relevant folders before compilation.
