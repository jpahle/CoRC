...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2013-07-31T10:54:29Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2013-07-31T10:54:52Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2013-07-31T10:56:59Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt." value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Reactions[reaction_1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=v" value="1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Reactions[reaction_2]" type="Reaction">
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Reactions[reaction_2],ParameterGroup=Parameters,Parameter=k1,Reference=Value"/>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="Experiment_1">
            ...
            <Parameter name="File Name" type="file" value="test_paramest_exp_data.txt"/>
            ...
            <ParameterGroup name="Object Map">
              ...
              <ParameterGroup name="1">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
                <Parameter name="Weight" type="unsignedFloat" value="1"/>
              </ParameterGroup>
              <ParameterGroup name="2">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=Concentration"/>
                <Parameter name="Role" type="unsignedInteger" value="2"/>
              </ParameterGroup>
            </ParameterGroup>
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[A]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[B]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Simple test for parameter estimation in conjunction with simple_exp_data.txt.,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="Parameter Estimation Result" type="Plot2D" active="1">
      ...
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment,[A](Measured Value)" type="Curve2D">
        ...
        <PlotItem name="Experiment,[A](Fitted Value)" type="Curve2D">
          <Parameter name="Color" type="string" value="#FF0000"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1"/>
        ...
        <PlotItem name="Experiment,[A](Weighted Error)" type="Curve2D">
          <Parameter name="Color" type="string" value="#FF0000"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="Experiment,[B](Measured Value)" type="Curve2D">
        ...
        <PlotItem name="Experiment,[B](Fitted Value)" type="Curve2D">
          <Parameter name="Color" type="string" value="#0000FF"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1"/>
        ...
        <PlotItem name="Experiment,[B](Weighted Error)" type="Curve2D">
          <Parameter name="Color" type="string" value="#0000FF"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Line width" type="unsignedFloat" value="1"/>
