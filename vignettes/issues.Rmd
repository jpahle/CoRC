...
# Timecourse looks different in GUI

GUI: a, b = 1
CoRC: a, b = 6.022141e+20

```{r}
newModel()
newSpecies("a")
newSpecies("b", type = "assignment", expression = "{[a]}")
setSpecies("a", type = "assignment", expression = "{[b]} + 1")
runTC(duration = 1, intervals = 100)
unloadModel()
setCurrentModel(getLoadedModels()[[1]])
```
