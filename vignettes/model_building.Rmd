...
Working with reaction schemes automatically creates required entities the same way the Copasi GUI does.
...
The `runTC` function only returns actual defined entities of the model.
Auxiliarry information like reaction rates can be missing and and need to be added via global quantity assignment.
